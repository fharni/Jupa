...
CREATE INDEX audit_club_ID_fk
  ON audit (club_id);
CREATE INDEX audit_user_ID_fk
  ON audit (auditor_id);
CREATE INDEX audit_status_id_fk
  ON audit (status_id);
CREATE INDEX audit_discipline_id_fk
  ON audit (discipline_id);
...
CREATE INDEX audit_user_audit_id_fk
  ON audit_user (audit_id);
CREATE INDEX audit_user_user_ID_fk
  ON audit_user (user_id);
CREATE INDEX audit_user_grading_ID_fk
  ON audit_user (grading_id);
