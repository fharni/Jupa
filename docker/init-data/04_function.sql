...
INSERT INTO `FUNCTION` (ID, FUNCTION) VALUES (5, 'menu.federation');
INSERT INTO `FUNCTION` (ID, FUNCTION) VALUES (6, 'club.list');
INSERT INTO `FUNCTION` (ID, FUNCTION) VALUES (7, 'club.create_modify_delete');
